...
while True:
    ...
    # Ściany: jeżeli piłka wykracza poza okno z lewej lub prawej strony
    # odbij ją od ściany
    ...
    # jeżeli piłka wyszła poza pole gry u góry lub z dołu
    # ustaw domyślną pozycję piłki
