...
def konstruktor(x, y, z, roz=10, blok=block.AIR, gracz=False):
    """Funkcja wypełnia sześcienny obszar od podanej pozycji
    podanym rodzajem bloku i opcjonalnie umieszcza gracza w środku.
    ...
    # czyszczenie
    mc.setBlocks(x, y, z, x + roz, y + roz, z + roz, blok)
