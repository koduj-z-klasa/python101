...
def main(args):
    ...
    # KOŁO
    sleep(2)  # poczekaj 2 sekundy
    figura.drawCircle(0, 10, 0, 10, block.LEAVES, 2)

    # KULA
    sleep(2)  # poczekaj 2 sekundy
    figura.drawSphere(0, 10, 0, 9, block.WOOD, 2)

    # TRÓJKĄT
    ksztalt = []  # lista punktów
    ksztalt.append(Vec3(-11, 0, 11))
    ksztalt.append(Vec3(11, 0, 11))
    ksztalt.append(Vec3(0, 0, -11))
